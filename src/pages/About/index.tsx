            ...
            <Container>
                <GenericHtml>
                    ...
                    <p>
                        ...
                        trabalho em blocos de tempo intercalados
                    ...
                    <ul>
                        <li>
                            <strong> Defina uma tarefa</strong> que você deseja realizar.
                        </li>
                        <li>
                            <strong> Trabalhe nela por 25 minutos</strong> sem interrupções.
                        </li>
                        <li>
                            <strong> Faça uma pausa curta de 5 minutos</strong>.
                        </li>
                        <li>
                            <strong> A cada 4 ciclos, faça uma pausa longa</strong> (geralmente 15 a 30 minutos).
                        </li>
                    </ul>

                    <h2>
                        Mas no <strong>ZenTime</strong> temos um diferencial 🚨
                    </h2>
                    ...
                    <h2>Por que usar o ZenTime?</h2>
                    <ul>
                        <li>✅ Organize suas tarefas diárias com mais foco.</li>
